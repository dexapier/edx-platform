define(["jquery", "underscore", "gettext", "js/models/asset", "js/views/paging", "js/views/asset",
    "js/views/paging_header", "js/views/paging_footer", "js/utils/modal", "jquery.fileupload"],
    function($, _, gettext, AssetModel, PagingView, AssetView, PagingHeader, PagingFooter, ModalUtils) {
        ...
        var AssetsView = PagingView.extend({
            ...
            afterRender: function(){
                ...
                $('#content').on('click', '.uploads .upload-button', assetsView.showUploadModal);
                $('.upload-modal .close-button').on('click', assetsView.hideModal);
                $('.upload-modal .choose-file-button').on('click', assetsView.showFileSelectionMenu);
                return this;
            },
